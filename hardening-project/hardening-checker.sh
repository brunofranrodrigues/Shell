...
log_automation="/tmp/h_output.log"
...
[ $? = 0 ] && ${ECHO} ${MC} "${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} "${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1))
}
...
[ $? = 0 ] && ${ECHO} ${MC} " - [logrotate.conf] create 0600 entry ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - [logrotate.conf] create 0600 entry ${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1))
cmd=$(${GREP} -m 1 utmp /etc/logrotate.conf | ${GREP} "create 0640")
[ $? = 0 ] && ${ECHO} ${MC} " - [logrotate.conf] utmp permission ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - [logrotate.conf] utmp permission ${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1))
}
...
then
	...
	[ $? = 0 ] && ${ECHO} ${MC} " - [login.defs] PASS_MIN_LEN ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - [login.defs] PASS_MIN_LEN ${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1))
	#cmd=$(${EGREP} "PASS_MIN_DAYS.*${PASS_MIN_DAYS}" /etc/login.defs)
	#[ $? = 0 ] && ${ECHO} ${MC} " - [login.defs] PASS_MIN_DAYS ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - [login.defs] PASS_MIN_DAYS ${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1))
	cmd=$(${EGREP} "difok=${DIFOK}" /etc/pam.d/common-password)
	[ $? = 0 ] && ${ECHO} ${MC} " - [common-password] difok ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - [common-password] difok ${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1))
	cmd=$(${EGREP} "minlen=${PASS_MIN_LEN}" /etc/pam.d/common-password)
	[ $? = 0 ] && ${ECHO} ${MC} " - [common-password] minlen ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - [common-password] minlen ${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1))
	cmd=$(${EGREP} "dcredit=${DCREDIT}" /etc/pam.d/common-password)
	[ $? = 0 ] && ${ECHO} ${MC} " - [common-password] dcredit ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - [common-password] dcredit ${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1))
	cmd=$(${EGREP} "lcredit=${LCREDIT}" /etc/pam.d/common-password)
	[ $? = 0 ] && ${ECHO} ${MC} " - [common-password] lcredit ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - [common-password] lcredit ${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1))
	cmd=$(${EGREP} "ucredit=${UCREDIT}" /etc/pam.d/common-password)
	[ $? = 0 ] && ${ECHO} ${MC} " - [common-password] ucredit ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - [common-password] ucredit ${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1))
	cmd=$(${EGREP} "ocredit=${OCREDIT}" /etc/pam.d/common-password)
	[ $? = 0 ] && ${ECHO} ${MC} " - [common-password] ocredit ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - [common-password] ocredit ${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1))
	cmd=$(${EGREP} "remember=${REMEMBER}" /etc/pam.d/common-password)
	[ $? = 0 ] && ${ECHO} ${MC} " - [common-password] remember ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - [common-password] remember ${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1))
elif [[ $i == 1 ]] || [[ $i == 4 ]]
then
	cmd=$(${EGREP} "PASS_MIN_LEN.*${PASS_MIN_LEN}" /etc/login.defs)
	[ $? = 0 ] && ${ECHO} ${MC} " - [login.defs] PASS_MIN_LEN ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - [login.defs] PASS_MIN_LEN ${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1))
	...
	[ $? = 0 ] && ${ECHO} ${MC} " - [system-auth] difok ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - [system-auth] difok ${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1))
	cmd=$(${EGREP} "minlen=${PASS_MIN_LEN}" /etc/pam.d/system-auth)
	[ $? = 0 ] && ${ECHO} ${MC} " - [system-auth] minlen ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - [system-auth] minlen ${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1))
	cmd=$(${EGREP} "dcredit=${DCREDIT}" /etc/pam.d/system-auth)
	[ $? = 0 ] && ${ECHO} ${MC} " - [system-auth] dcredit ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - [system-auth] dcredit ${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1))
	cmd=$(${EGREP} "lcredit=${LCREDIT}" /etc/pam.d/system-auth)
	[ $? = 0 ] && ${ECHO} ${MC} " - [system-auth] lcredit ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - [system-auth] lcredit ${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1))
	cmd=$(${EGREP} "ucredit=${UCREDIT}" /etc/pam.d/system-auth)
	[ $? = 0 ] && ${ECHO} ${MC} " - [system-auth] ucredit ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - [system-auth] ucredit ${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1))
	cmd=$(${EGREP} "ocredit=${OCREDIT}" /etc/pam.d/system-auth)
	[ $? = 0 ] && ${ECHO} ${MC} " - [system-auth] ocredit ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - [system-auth] ocredit ${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1))
	cmd=$(${EGREP} "remember=${REMEMBER}" /etc/pam.d/system-auth)
	[ $? = 0 ] && ${ECHO} ${MC} " - [system-auth] remember ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - [system-auth] remember ${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1))
fi
}
...
if [[ $i == 2 ]] || [[ $i == 3 ]]
then
  [ `stat -c '%a' /etc/crontab` -eq 600 ] && ${ECHO} ${MC} " - /etc/crontab permission ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - /etc/crontab permission ${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1))
  cmd=$(${LS} -ltr /etc/crontab | ${AWK} '{ print $3 }' | ${GREP} -e "root")
  [ $? = 0 ] && ${ECHO} ${MC} " - /etc/crontab owner ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - /etc/crontab owner ${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1))
  cmd=$(${GREP} root /etc/cron.allow)
  [ $? = 0 ] && ${ECHO} ${MC} " - root listed on /etc/cron.allow ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - root listed on /etc/cron.allow ${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1)) 
elif [[ $i == 1 ]] || [[ $i == 4 ]]
then
  [ `stat -c '%a' /etc/crontab` -eq 600 ] && ${ECHO} ${MC} " - /etc/crontab permission ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - /etc/crontab permission ${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1))
...
${ECHO} "Checking (Desativando servicos desnecessarios)  "
	for i in $ALLOWSVS; do
		...
		[ $? = 0 ] && ${ECHO} ${MC} " - [services] ${i} ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - [services] ${i} ${RED}[FAIL]${UNCOLOR} - disable it!" | COUNTER=$(($COUNTER+1))
	done
}
...
#[ -e /etc/modprobe.d/secadm.conf ] && ${ECHO} ${MC} "${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} "${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1))
#}
...
then
  ...
  [ $? = 0 ] && ${ECHO} ${MC} " - /etc/shadow owner ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - /etc/shadow owner ${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1))
  cmd=$(${LS} -ltr /etc/gshadow | ${AWK} '{ print $3 }' | ${GREP} -e "root")
  [ $? = 0 ] && ${ECHO} ${MC} " - /etc/gshadow owner ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - /etc/gshadow owner ${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1))
  [ `stat -c '%a' /etc/shadow` -eq 0 ] && ${ECHO} ${MC} " - /etc/shadow permission ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - /etc/shadow permission ${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1))
  [ `stat -c '%a' /etc/gshadow` -eq 0 ] && ${ECHO} ${MC} " - /etc/gshadow permission ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - /etc/gshadow permission ${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1))
elif [[ $i == 1 ]] || [[ $i == 4 ]]
then
...
for i in $DENYSIDS; do 
     if [ -f ${i} ]; then
          cmd=$(stat -c '%a' ${i})
          [ ${cmd} -eq 4755 ] && ${ECHO} ${MC} " - ${i} permission ${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1)) || ${ECHO} ${MC} " - ${i} permission ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1))
     else
          continue
     fi
done
...
[ `stat -c '%a' ${i}` -eq 700 ] && ${ECHO} ${MC} " - ${i} permission ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - ${i} permission ${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1))
done
}
...
if [ -e $cmd ]; then
     ${ECHO} ""
     for i in $cmd; do
          ${ECHO} ${MC} " - ${i} found ${RED}[FAIL]${UNCOLOR}"
          COUNTER=$(($COUNTER+1))
     done
else
...
[ $? = 0 ] && ${ECHO} ${MC} " - [limits.conf] hard core ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - [limits.conf] hard core ${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1))
cmd=$(${GREP} "fs.suid_dumpable = 0" /etc/sysctl.conf)
[ $? = 0 ] && ${ECHO} ${MC} " - [sysctl.conf] fs.suid_dumpable ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - [sysctl.conf] fs.suid_dumpable ${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1))
}
...
[ $? = 0 ] && ${ECHO} ${MC} " - /etc/motd content ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - /etc/motd content ${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1))
...
[ $? = 0 ] && ${ECHO} ${MC} " - /etc/issue.net content${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - /etc/issue.net content${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1))
}
...
[ $? = 0 ] && ${ECHO} ${MC} " - [sshd_config] PermitEmptyPasswords ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - [sshd_config] PermitEmptyPasswords ${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1))
cmd=$(${EGREP} "PermitRootLogin $ALLOW_ROOT_LOGIN" /etc/ssh/sshd_config)
[ $? = 0 ] && ${ECHO} ${MC} " - [sshd_config] PermitRootLogin ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - [sshd_config] PermitRootLogin ${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1))
#cmd=$(${EGREP} "IgnoreRhosts $IGNORE_RHOSTS" /etc/ssh/sshd_config)
#[ $? = 0 ] && ${ECHO} ${MC} " - [sshd_config] IgnoreRhosts ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - [sshd_config] IgnoreRhosts ${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1))
#cmd=$(${EGREP} "RhostsRSAAuthentication $ALLOW_RHOSTS_RSA" /etc/ssh/sshd_config)
#[ $? = 0 ] && ${ECHO} ${MC} " - [sshd_config] RhostsRSAAuthentication ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - [sshd_config] RhostsRSAAuthentication ${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1))
cmd=$(${EGREP} "Protocol 2" /etc/ssh/sshd_config)
[ $? = 0 ] && ${ECHO} ${MC} " - [sshd_config] Protocol ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - [sshd_config] Protocol ${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1))
#cmd=$(${EGREP} "UsePrivilegeSeparation yes" /etc/ssh/sshd_config)
#[ $? = 0 ] && ${ECHO} ${MC} " - [sshd_config] UsePrivilegeSeparation ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - [sshd_config] UsePrivilegeSeparation ${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1))
cmd=$(${EGREP} "StrictModes yes" /etc/ssh/sshd_config)
[ $? = 0 ] && ${ECHO} ${MC} " - [sshd_config] StrictModes ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - [sshd_config] StrictModes ${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1))
cmd=$(${EGREP} "MaxAuthTries $MAX_AUTH_TRIES" /etc/ssh/sshd_config)
[ $? = 0 ] && ${ECHO} ${MC} " - [sshd_config] MaxAuthTries ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - [sshd_config] MaxAuthTries ${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1))
cmd=$(${EGREP} "AllowTcpForwarding $ALLOW_TCP_FORWARD" /etc/ssh/sshd_config)
[ $? = 0 ] && ${ECHO} ${MC} " - [sshd_config] AllowTcpForwarding ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - [sshd_config] AllowTcpForwarding ${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1))
cmd=$(${EGREP} "X11Forwarding $ALLOW_X11_FORWARD" /etc/ssh/sshd_config)
[ $? = 0 ] && ${ECHO} ${MC} " - [sshd_config] X11Forwarding ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - [sshd_config] X11Forwarding ${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1))
cmd=$(${EGREP} "SyslogFacility AUTHPRIV" /etc/ssh/sshd_config)
[ $? = 0 ] && ${ECHO} ${MC} " - [sshd_config] SyslogFacility ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - [sshd_config] SyslogFacility ${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1))
cmd=$(${EGREP} "LogLevel INFO" /etc/ssh/sshd_config)
[ $? = 0 ] && ${ECHO} ${MC} " - [sshd_config] LogLevel ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - [sshd_config] LogLevel ${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1))
cmd=$(${EGREP} "TCPKeepAlive $ALLOW_KEEPALIVE" /etc/ssh/sshd_config)
[ $? = 0 ] && ${ECHO} ${MC} " - [sshd_config] TCPKeepAlive ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - [sshd_config] TCPKeepAlive ${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1))
cmd=$(${EGREP} "PermitUserEnvironment no" /etc/ssh/sshd_config)
[ $? = 0 ] && ${ECHO} ${MC} " - [sshd_config] PermitUserEnvironment ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - [sshd_config] PermitUserEnvironment ${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1))
cmd=$(${EGREP} "LoginGraceTime $GRACE_TIME" /etc/ssh/sshd_config)
[ $? = 0 ] && ${ECHO} ${MC} " - [sshd_config] LoginGraceTime ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - [sshd_config] LoginGraceTime ${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1))
#cmd=$(${EGREP} "KeyRegenerationInterval 1800" /etc/ssh/sshd_config)
#[ $? = 0 ] && ${ECHO} ${MC} " - [sshd_config] KeyRegenerationInterval ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - [sshd_config] KeyRegenerationInterval ${RED}[FAIL]${UNCOLOR}" ${YELLOW}ignore!${UNCOLOR}| COUNTER=$(($COUNTER+1))
cmd=$(${EGREP} "UseDNS $USE_DNS" /etc/ssh/sshd_config)
[ $? = 0 ] && ${ECHO} ${MC} " - [sshd_config] UseDNS ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - [sshd_config] UseDNS ${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1))
#cmd=$(${EGREP} "ServerKeyBits $SERVERKEY_BITS" /etc/ssh/sshd_config)
#[ $? = 0 ] && ${ECHO} ${MC} " - [sshd_config] ServerKeyBits ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - [sshd_config] ServerKeyBits ${RED}[FAIL]${UNCOLOR}" ${YELLOW}ignore!${UNCOLOR}| COUNTER=$(($COUNTER+1))
cmd=$(${EGREP} "RSAAuthentication $RSA_AUTH" /etc/ssh/sshd_config)
[ $? = 0 ] && ${ECHO} ${MC} " - [sshd_config] RSAAuthentication ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - [sshd_config] RSAAuthentication ${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1))
#cmd=$(${EGREP} "PubkeyAuthentication $PUBKEY_AUTH" /etc/ssh/sshd_config)
#[ $? = 0 ] && ${ECHO} ${MC} " - [sshd_config] PubkeyAuthentication ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - [sshd_config] PubkeyAuthentication ${RED}[FAIL]${UNCOLOR}" ${YELLOW}ignore!${UNCOLOR}| COUNTER=$(($COUNTER+1))
cmd=$(${EGREP} "ChallengeResponseAuthentication $CHALLENGE_PAM" /etc/ssh/sshd_config)
[ $? = 0 ] && ${ECHO} ${MC} " - [sshd_config] ChallengeResponseAuthentication ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - [sshd_config] ChallengeResponseAuthentication ${RED}[FAIL]${UNCOLOR} "| COUNTER=$(($COUNTER+1))
cmd=$(${EGREP} "KerberosAuthentication $KERBEROS_AUTH" /etc/ssh/sshd_config)
[ $? = 0 ] && ${ECHO} ${MC} " - [sshd_config] KerberosAuthentication ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - [sshd_config] KerberosAuthentication ${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1))
cmd=$(${EGREP} "GSSAPIAuthentication $GSSAPI_AUTH" /etc/ssh/sshd_config)
[ $? = 0 ] && ${ECHO} ${MC} " - [sshd_config] GSSAPIAuthentication ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - [sshd_config] GSSAPIAuthentication ${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1))
cmd=$(${EGREP} "PrintLastLog yes" /etc/ssh/sshd_config)
[ $? = 0 ] && ${ECHO} ${MC} " - [sshd_config] PrintLastLog ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - [sshd_config] PrintLastLog ${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1))
cmd=$(${EGREP} "UsePAM yes" /etc/ssh/sshd_config)
[ $? = 0 ] && ${ECHO} ${MC} " - [sshd_config] UsePAM ${GREEN}[OK]${UNCOLOR}"| COUNTEROK=$(($COUNTEROK+1)) || ${ECHO} ${MC} " - [sshd_config] UsePAM ${RED}[FAIL]${UNCOLOR}"| COUNTER=$(($COUNTER+1))
}
...
if [ ${COUNTER} -gt 0 ]; then
     ...
     ${ECHO} ${MC} "#################################################"
     ${ECHO} ${MC} ""
     ${ECHO} "failed:${COUNTER}" > $log_automation
     ${ECHO} "success:${COUNTEROK}" >> $log_automation
     ${ECHO} "status:nao" >> $log_automation
else
     ${ECHO} ${MC} ""
     ${ECHO} ${MC} "#########################################"
     ...
     ${ECHO} ${MC} "#########################################"
     ${ECHO} ${MC} ""
     ${ECHO} "failed:0" > $log_automation
     ${ECHO} "success:${COUNTEROK}" >> $log_automation
     ${ECHO} "status:sim" >> $log_automation
fi
}
